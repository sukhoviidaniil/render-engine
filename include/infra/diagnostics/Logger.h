...
#ifdef _DEBUG
#define LOG(x) sif::infra::diag::Logger::instance().write(x)
#define LOG_ADD_DEPTH() sif::infra::diag::Logger::instance().add_depth();
#define LOG_LOWER_DEPTH() sif::infra::diag::Logger::instance().lower_depth();
#else
#define LOG(x)
